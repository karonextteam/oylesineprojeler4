...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Katalog ID'leri (SemptomKatalog.Id): 7=Nefes darlığı, 32=Göğüs ağrısı,
    // 33=Çarpıntı, 34=Baygınlık hissi
    const KRITIK_TEKLI   = [7, 32, 34];
    const KRITIK_KOMBIN  = [
        { ids: [32,  7], seviye: 'acil'   }, // Göğüs ağrısı + Nefes darlığı
        { ids: [32, 34], seviye: 'acil'   }, // Göğüs ağrısı + Baygınlık hissi
        { ids: [32, 33], seviye: 'acil'   }, // Göğüs ağrısı + Çarpıntı
        { ids: [ 7, 34], seviye: 'dikkat' }, // Nefes darlığı + Baygınlık hissi
    ];
    const MESAJLAR = {
        acil: {
