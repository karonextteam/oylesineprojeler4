...
public class HomeController(AppDbContext db, UserManager<Kullanici> userManager, ILogger<HomeController> logger) : Controller
{
    ...
    public async Task<IActionResult> Dashboard()
    {
        ...
        {
            logger.LogError(ex, "Dashboard verileri yüklenirken hata oluştu.");
            TempData["Hata"] = "Dashboard yüklenirken teknik bir hata oluştu. Bazı veriler eksik gösterilebilir.";
            return View(new DashboardViewModel { KullaniciAd = "Kullanıcı", SonAnalizler = [] });
        }
    }
}
