    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    Ad = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    Soyad = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ad = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    Aciklama = table.Column<string>(type: "TEXT", maxLength: 1500, nullable: false),
                    OnerilenBolum = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kategori = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    OlusturulmaTarihi = table.Column<DateTime>(type: "TEXT", nullable: false),
                    GuncellenmeTarihi = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EkNotlar = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    SemptomImzasi = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    OlusturulmaTarihi = table.Column<DateTime>(type: "TEXT", nullable: false),
                    GuncellenmeTarihi = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cinsiyet = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    ...
                    KronikHastaliklar = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IkonKodu = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnerilenBolum = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    NedenAciklamasi = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    GenelYorum = table.Column<string>(type: "TEXT", maxLength: 3000, nullable: false),
